...
def recuperation_calendrier(jour:int):
    if jour == 1:
        file = "divers/devoxx1.html"
        url0 = "https://www.devoxx.fr/agenda-2025/Schedule/"
    elif jour == 2:
        file = "divers/devoxx2.html"
        url0 = "https://www.devoxx.fr/agenda-2025/Schedule/?id=Thursday"
    elif jour == 3:
        file = "divers/devoxx3.html"
    ...
    my_file = Path(file)
    if my_file.is_file():
        print(f"lecture fichier {file} sur le FS")
        ...
        url = url0
        print(f"lecture fichier {file} sur le web")
...
def analyse_journee(jour:int):

    a_dict = {}


    contenu=recuperation_calendrier(jour)
...
dict1=analyse_journee(1)
dict2=analyse_journee(2)
dict3=analyse_journee(3)

if dict1 is None:
    raise "Erreur pour le jour 1"
if dict2 is None:
    raise "Erreur pour le jour 2"
if dict3 is None:
    raise "Erreur pour le jour 3"

dict_complet= {'liste1': dict1['liste'], 'liste2': dict2['liste'], 'liste3': dict3['liste']}

with open('docs/data_complet.json', 'w') as outfile:
    json.dump(dict_complet, outfile,indent=4)
